...
const paths: Record<IconName, React.ReactElement> = {
  ...
  "arrow-up": <path d="M12 5 6 11h3v8h6v-8h3L12 5Z" fill="currentColor" />,
  bullseye: (
    <>
      <path
        fillRule="evenodd"
  ...
  bolt: <path d="M13 2 6 13h4l-1 9 7-11h-4l1-9Z" fill="currentColor" />,
  shield: (
    <path
  ...
  microscope: (
    <path
      d="M3 22h18M7 19h7M9 16h3M12 5v7M13 11H8M9 12V5H7V12h2ZM9 6h1V4H9v2Zm.5-2h2V2h-2v2Zm2.5 1h1V4h-1v1Zm1 4c3.3 0 6 2.7 6 6 0 2.2-1.2 4.1-2.9 5.1"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
